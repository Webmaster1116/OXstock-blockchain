...
<?php
...

	{
		...
		$our_solution=$data['our_solution'];				
...

	{
		...
		$learn_more=$_REQUEST['learn_more'];				
		
		$our_solution=$_REQUEST['our_solution'];	
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label for="title" class="col-sm-2 form-control-label">Learn More(Link)</label>

                                                        <div class="col-sm-10">

                                                            <div class="input-group">                                                               

                                                                <input type="text" name="learn_more" id="learn_more" class="form-control" value="<?php echo $learn_more; ?>" /> 
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label for="title" class="col-sm-2 form-control-label">Our Solution(Link)</label>

                                                        <div class="col-sm-10">

                                                            <div class="input-group">                                                               

                                                                <input type="text" name="our_solution" id="our_solution" class="form-control" value="<?php echo $our_solution; ?>" /> 
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="input-group"><small>(Size: W 1920px X  H 755px)</small></div>
...

{
    	...
    	$arr = array( "title"=>$_POST['title'], "sub_title"=>$_POST['sub_title'],"learn_more"=>$_POST['learn_more'],"our_solution"=>$_POST['our_solution'],"image" => $image,"status"=>$_POST['status']);
