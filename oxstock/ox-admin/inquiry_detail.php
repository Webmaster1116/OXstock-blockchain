                ...
                <div class="col-xl-12 ks-draggable-column">
                    <div class="card panel panel-table" data-dashboard-widget>
                        ...
                        <div class="card-block ks-scrollable" data-height="290" data-widget-content>
                        	<?php
								  $inq_history = "select * from `".TB_INQUIRY."` where id='".$_GET['id']."'";
								  $inq_record = mysqli_query($con, $inq_history);
								  $inq_list = mysqli_fetch_array($inq_record);
                              ?>
                            <table class="table table-bordered table-striped">
                                <tbody>
                                	...
                                	<tr>
                                    	<th>Message</th>
                                    	<td><?php echo $inq_list['message']; ?></td> 
                                	</tr>
                                    <?php
									$listpagename = INQUIRY_LIST;
									?>
                                    <tr>
                                    	<td colspan="2" class="text-left"><a class="btn btn-danger right" href="<?php echo URL_BASEADMIN . $listpagename; ?>">Back</a></td> 
                                	</tr>
                                </tbody>
                            </table>
                        </div>
