                                                ...
                                                <div class="card">                                                
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="content_about" class="col-sm-2 form-control-label">Description(About)</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">   
                                                                        <textarea name="content_about" id="contentFirst" class="form-control"><?php echo $content_about; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label for="content" class="col-sm-2 form-control-label">Description(Why Choose Us)</label>
...
CKEDITOR.replace('content_about', {toolbar: 'Basic', height: 250});
...
if (isset($_POST['addnew'])) {
	...
	$arr = array("title"=>replacequoteb($_POST['title']),"titlebar"=>$_POST['titlebar'],"metad"=>$_POST['metad'],"metak"=>$_POST['metak'],"content"=>replacequoteb($_POST['content']), "content_about"=>replacequoteb($_POST['content_about']) );
