                            ...
                            <div class="ks-dashboard-tabbed-sidebar">
                                <div class="ks-dashboard-tabbed-sidebar-widgets">                 
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="btn btn-primary btn-sm" href="<?php echo URL_BASEADMIN.GALLERY_EDIT;?>" >Add Gallery</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                                            ...
                                                            <tr>
                                                                ...
                                                                if (mysqli_num_rows($sel) > 0) {
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo $i + 1; ?></td>
                                                                        <td>
                                                                            <img src="<?php echo URL_BASE.DIR_UPLOADS.$res['image']; ?>" height="150" width="200" />
                                                                        </td>
