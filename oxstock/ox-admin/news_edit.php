                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div>                                                	
                                                          ...
                                                          <?php /*?>  
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="imagetrigger" class="col-sm-2 form-control-label">News Image</label>
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div class="input-group"><small>(Size: W 1170px X  H 440px)</small></div>
                                                                </div>
                                                            </div>
                                                            <?php
                                                            if ($image) {
