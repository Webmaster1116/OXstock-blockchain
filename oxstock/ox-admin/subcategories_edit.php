...
<?php
	...
	$listpagename = SUB_CATEGORIES_LIST;

	$table = TB_SUB_CATEGORIES;
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group row">
                                                              ...
                                                              <label for="product_id" class="col-sm-2 form-control-label">Product</label>
                                                                  ...
                                                                  <div class="input-group">                                                               
                                                                      ...
                                                                      <select name="product_id" id="product_id" class="form-control">
																		  ...
																		  while ($resPro = mysqli_fetch_array($selProduct)) {
                                                                              ...
                                                                              <option value="<?php echo $resPro['id']; ?>" <?php if ($product_id == $resPro['id']) { ?> selected <?php } ?> ><?php echo $resPro['title']; ?></option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label for="categories_id" class="col-sm-2 form-control-label">Sub Categories</label>
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <div class="input-group">                                                               
                                                                ...
                                                                <select name="categories_id" id="categories_id" class="form-control">
                                                                    ...
                                                                    $selCat = selectqry('*', TB_CATEGORIES, array(), 'title');

                                                                    while ($resCat = mysqli_fetch_array($selCat)) {

                                                                        ?>

                                                                        <option value="<?php echo $resCat['id']; ?>" <?php if ($categories_id == $resCat['id']) { ?> selected <?php } ?> ><?php echo $resCat['title']; ?></option>
...
$("#url").blur(function(){
	...
	$('#resultUrl').html('Checking....');
			...
			$.post('<?php echo URL_BASEADMIN.DIR_INCLUDES; ?>subcategory_ajax.php?ptype=url&type=checkurl&value='+$('#url').val()+'&notid=<?php echo $_REQUEST['id']; ?>', function(retdata) {
...
function chkrequired(){
	...
	var chk=new Array();
	chk['t:product_id'] = "Product.";	

	chk['t:categories_id'] = "Categories.";	
...

{
    ...
    $arr = array( "product_id"=>$_POST['product_id'],"categories_id" => $_POST['categories_id'],"title"=>replacequoteb($_POST['title']),"status"=>$_POST['status'], "image" => $image  );
