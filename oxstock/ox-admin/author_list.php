                        ...
                        <div class="ks-page-content-body">
                            ...
                            <div class="ks-dashboard-tabbed-sidebar">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="btn btn-primary btn-sm" href="<?php echo URL_BASEADMIN.AUTHOR_EDIT;?>" >Add Author</a>
                                        </div>
                                    </div>                
...
$(document).ready(function() {					
	...
	$('.statuschange').click(function() {
		...
		$.post('<?php echo URL_BASEADMIN.DIR_INCLUDES; ?>author_ajax.php?ptype=list&type=statuschange&id='+myobj.attr('rid') , function(retdata) {
