                                                ...
                                                <div class="card">                                                
                                                    <div class="card-block">
                                                        <div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="task_date" class="col-sm-2 form-control-label">Task Date</label>
                                                                <div class="col-sm-10">
                                                                    <div class="input-group">
                                                                        <input type="text" name="task_date" id="task_date" class="form-control calendar" data-enable-time="false" data-enable-seconds="false"  value="<?php if (empty($task_date)) { echo date('Y-m-d'); } else { echo $task_date; } ?>" data-date-format="Y-m-d" /> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
...
if (isset($_POST['addnew'])) {
    ...
    $arr = array( "company_id" => $_POST['company_id'], "user_id" => $_POST['user_id'], "title" => $_POST['title'], "description" => $_POST['description'], "task_date" => $_POST['task_date'], "created_at" => $created_at );
