...
if ($permission['view']) {
    ...
    $qry .= " `company`.`company_name`, `client`.`company_name`, `user`.`username`, `user`.`first_name`, `user`.`last_name`";
    $qry .= " from " . $table . " ";
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card ks-card-widget ks-widget-table">
                                                <div class="card-block">
                                                    <table class="table ks-payment-table-invoicing" id="example" class="display" >
                                                        <tbody>
                                                            <tr>
                                                                <th width="1">#</th>
                                                                <th>Company</th>
                                                            ...
                                                            if (mysqli_num_rows($sel) > 0) {
                                                                ...
                                                                while ($row = mysqli_fetch_array($sel)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="<?php echo URL_BASEADMIN . 'generate_pdf.php?true&id='.$row['id'].'&page=1' ?>" target="_blank">
