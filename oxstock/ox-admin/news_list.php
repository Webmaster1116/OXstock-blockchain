                        ...
                        <div class="ks-page-content-body">            
                            <div class="ks-dashboard-tabbed-sidebar">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="btn btn-primary btn-sm" href="<?php echo URL_BASEADMIN.NEWS_EDIT;?>" >Add News</a>
                                        </div>
                                    </div>              
                                    <div class="row">
                                        <div class="col-lg-12">
                                                            ...
                                                            if (mysqli_num_rows($sel) > 0) {
                                                                ...
                                                                while ($res = mysqli_fetch_array($sel)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($permission['del'] &&  $res['id'] > 1) { ?><a class="btn btn-danger btn-sm" href="javascript:" onclick="return deletesure('<?php echo $res['id']; ?>', '<?php echo $table; ?>', '');">Delete</a><?php } ?>																
                                                                        </td>
                                                                    </tr>
                                                                            <?php
                                                                            $i++;
