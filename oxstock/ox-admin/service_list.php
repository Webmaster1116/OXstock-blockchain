                            ...
                            <div class="ks-dashboard-tabbed-sidebar">
                                <div class="ks-dashboard-tabbed-sidebar-widgets">  
                                	<div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a class="btn btn-primary btn-sm" href="<?php echo URL_BASEADMIN.SERVICE_EDIT;?>" >Add Service</a>
                                        </div>
                                    </div>                
                                    <div class="row">
                                        <div class="col-lg-12">
...
$(document).ready(function() {					
	$('.statuschange').click(function() {
		...
		$.post('<?php echo URL_BASEADMIN.DIR_INCLUDES; ?>service_ajax.php?ptype=list&type=statuschange&id='+myobj.attr('rid') , function(retdata) {
			myobj.html(retdata);
		});	
	});
});
