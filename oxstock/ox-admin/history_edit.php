                                            ...
                                            <div class="card-block">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label for="title" class="col-sm-2 form-control-label">Year</label>
...

{
    	...
    	$arr = array( "title"=>$_POST['title'], "year"=>$_POST['year'],"description"=>$_POST['description'],"image" => $image,"status"=>$_POST['status']);
