...
<?php // include(DIR_BASE.'user_header.php');?>
<body>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        <div class="payment-wrap">
                                            ...
                                            <p>Your Payment for <?php echo($transaction->amount)?> $ was Successfully Completed</p>
...
<div class="wrapper">
    <div class="response container">
        <div class="content">
            ...
            <section>
                <a class="button primary back" href="wallet.php">
